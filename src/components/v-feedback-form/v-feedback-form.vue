      ...
      <v-col  md="8" sm="11"  class="right-column">
        ...
        <div class="d-flex align-content-center right-column__item_second">
          <h3 class="d-flex align-self-center">
            добавить фото <span class="mdi mdi-plus"></span>
          </h3>
